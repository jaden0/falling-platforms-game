...
class PlatformFactory(object):
    def __init__(self, game, player):
        ...
        self.numberTileUnits = 10
        self.tileWidth = self.gameWidth // self.numberTileUnits
        ...
        self.tileImages = []
        for i in range(1,37):
            self.tileImages.append(pygame.transform.scale(pygame.image.load("images/tiles/rock/tile%d.png" % i), (self.tileWidth, self.tileWidth)))
    ...
    def suggestPlatform(self, game):
        ...
        numberTiles = random.randint(2, self.numberTileUnits-1)
        width = self.tileWidth * numberTiles - self.imagePadding * 2
        ...
        aPlatform.tileWidth = self.tileWidth
        aPlatform.imagePadding = self.imagePadding
        for i in range( 0, numberTiles-2):
            aPlatform.tileImages.append( self.tileImages[29])
        aPlatform.tileImages.append( self.tileImages[30])
